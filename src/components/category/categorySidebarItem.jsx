function CategorySidebarItem({ id, name, url }) {
  return (
    <div className="relative flex items-center w-full">
      ...
      <div className="absolute top-0 right-0 w-1 h-full bg-green-600 rounded-bl-lg rounded-tl-lg lg:rounded-none lg:left-0"></div>
      {/*content*/}
      <div className="flex flex-col w-full py-2 items-center hover:bg-[#EBFFEF] cursor-pointer border-b border-solid border-[#eeeeee] lg:p-3 lg:flex-row lg:gap-3">
